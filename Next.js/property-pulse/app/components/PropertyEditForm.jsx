...
const PropertyEditForm = () => {
    ...
    const [fields, setFields] = useState({
        ...
        baths: '',
        square_feet: '',
        amenities: ['Smart TV', 'Free Parking'],
        rates: {
            weekly: '',
            monthly: '',
            nightly: ''
    ...
    useEffect(() => {
        ...
        // Fetch proeprt data for form
        const fetchPropertyData = async () => {
            setLoading(true)
            try {
                const propertyData = await fetchProperty(id)

                // Check rates for null, if so replace with empty string
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            else if (res.status === 401 || res.status === 403) toast.error('Permission Denied')
